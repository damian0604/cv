...
\name{Damian}{Trilling}
\title{CV}
\address{Rietzangerweg 9}{1111VG Diemen}{The Netherlands}
...
\cventry{2021--2025}{ERC Starting Grant}{NEWSFLOWS:  Modeling News Flows: How Feedback Loops Influence Citizens' Beliefs and Shape Societies}{}{}{In this large-scale project, we use computational methods and field experiments to investigate feedback loops in news dissemination (\url{https://ccs.amsterdam/projects/newsflows/}).}
